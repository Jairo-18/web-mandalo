# Sitio de cuenta/legal de Mándalo (mandaloweb.ecohotelsamawe.com, Dokploy):
...
#   (https://apimandaloprod.ecohotelsamawe.com). Para una versión DEV de este
#   sitio: https://apimandalo.ecohotelsamawe.com.
...
ARG PUBLIC_API_URL=https://apimandaloprod.ecohotelsamawe.com
